...
import 'job_lists_model.dart';
export 'job_lists_model.dart';

class JobListsWidget extends StatefulWidget {
  const JobListsWidget({super.key});

  @override
  State<JobListsWidget> createState() => _JobListsWidgetState();
}

class _JobListsWidgetState extends State<JobListsWidget> {
  late JobListsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JobListsModel());
                                                    ...
                                                    padding:
                                                        EdgeInsetsDirectional
                                                            .fromSTEB(12.0, 4.0,
                                                                12.0, 16.0),
                                                    child: Text(
                                                      'We are looking for a skilled and experienced web developer to help us build a professional LinkedIn website for our office furniture business. The website should have a modern and sleek design that showcases our products and services effectively. The main goal of the website is to attract potential clients and provide them with information about our offerings.',
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                              .labelMedium
                                                    ...
                                                    padding:
                                                        EdgeInsetsDirectional
                                                            .fromSTEB(12.0, 4.0,
                                                                12.0, 16.0),
                                                    child: Text(
                                                      'We are seeking a skilled developer or development team to create a real-time video virtual try-on application. The application should allow users to virtually try on various items (e.g., clothing, accessories) using their video feed in real-time.',
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                              .labelMedium
