...
Future maybeCreateUser(User user) async {
  ...
  if (userExists) {
    currentUserDocument = await SignupRecord.getDocumentOnce(userRecord);
    return;
  }
  ...
  currentUserDocument = SignupRecord.getDocumentFromData(userData, userRecord);
}

Future updateUserDocument({String? email}) async {
  await currentUserDocument?.reference
      .update(createSignupRecordData(email: email));
}
